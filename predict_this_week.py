...
from this_weeks_games import get_this_weeks_games # Schedule Retrieval
...
if __name__ == '__main__':
	...
	print('Schedule loaded. Loading model...')
	...
	print(f'Predictions saved to predictions folder as predictions_{today.month}_{today.day}_{today.year}.csv')